...
const VideoCall = () => {
  ...
  return (
    <SafeAreaView style={styles.main}>
      ...
      >
        {/* Remote User Video (Larger when present) */}
        ...
        {/* Local User Video (PiP when remote is present) */}
        {isJoined && (
          <View
            style={[
              styles.localVideoContainer,
              remoteUid !== 0 ? styles.localVideoPiP : styles.localVideoFull,
            ]}
          >
            {isVideoEnabled && localUid ? (
              <RtcSurfaceView
                canvas={{
                  uid: 0,
                  sourceType: VideoSourceType.VideoSourceCamera,
            ...
            {showControls && <Text style={styles.localLabel}>You</Text>}
          </View>
        )}
        ...
        {showControls && (
          <View style={styles.controlsContainer}>
            ...
            <TouchableOpacity
              ...
              onPress={leave}
            >
              <PlatformIcon name="call" size={32} color="#ffffff" />
            </TouchableOpacity>
        ...
        {/* Status Messages (only show briefly) */}
