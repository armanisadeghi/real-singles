...
export default function GalleryIssuesPage() {
  ...
  const runCheck = async () => {
    ...
    try {
      const res = await fetch("/api/admin/data-integrity?type=gallery");
      if (!res.ok) {
        ...
        <div className="bg-white rounded-lg shadow p-8">
          <div className="text-center max-w-md mx-auto">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mb-2">
              Check Gallery Issues
            </h2>
            <p className="text-gray-600 mb-6">
              This check identifies gallery integrity issues like missing primary
              photos, orphaned records, and broken files. The process may take
              30+ seconds.
            </p>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow p-12">
          <div className="text-center">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mb-2">
              Checking Gallery Issues...
            </h2>
            <p className="text-gray-600">
              Verifying gallery integrity. This may take a minute.
            </p>
          </div>
        </div>
      </div>
