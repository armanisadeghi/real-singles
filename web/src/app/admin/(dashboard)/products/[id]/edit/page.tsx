...
export default function AdminEditProductPage({
      ...
      if (res.ok) {
        ...
        if (data.success && data.product) {
          ...
          setFormData({
            ...
            dollar_price: product.dollar_price?.toString() || "",
            retail_value: product.retail_value?.toString() || "",
          ...
          if (product.display_image_url) {
            setExistingImageUrl(product.display_image_url);
            setExistingImagePath(product.raw_image_url || null);
          }
        }
      }
    } catch (err) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      let imageUrl: string | null = existingImagePath;
