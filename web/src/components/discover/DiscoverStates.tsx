...
export function DiscoverSkeleton() {
  return (
    <div className="min-h-dvh bg-gray-50 flex flex-col animate-pulse">
      ...
      <div className="flex-1 flex flex-col md:flex-row md:items-start md:justify-center md:py-8 md:px-4 md:gap-6 max-w-6xl mx-auto w-full">
        ...
        <div className="relative md:sticky md:top-8 md:w-[400px] md:flex-shrink-0">
          ...
          <div className="md:rounded-2xl md:overflow-hidden md:shadow-lg">
            <div className="bg-gray-200 h-[55vh] md:h-[450px]" />
          </div>
...
export function NoMoreProfiles() {
  return (
    <div className="min-h-dvh bg-gradient-to-br from-pink-50 via-white to-purple-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link
            href="/explore"
            className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-pink-500 text-white rounded-full font-medium hover:bg-pink-600 transition-colors"
          >
          ...
          <Link
            ...
            className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-white text-gray-700 rounded-full font-medium border border-gray-300 hover:bg-gray-50 transition-colors"
          >
  ...
  return (
    <div className="min-h-dvh bg-gray-50 flex items-center justify-center">
      <div className="text-center">
        ...
        <p className="text-gray-600">Finding your next match...</p>
      </div>
    </div>
  );
}
