...
/**
 * Video intro recorder component.
 * Handles permission requests, recording, file upload, playback preview, and upload.
 */
export function VideoRecorder({
  ...
  }, [requestVideoPermission, videoStream, mimeType, maxDuration, stopVideoStream]);
